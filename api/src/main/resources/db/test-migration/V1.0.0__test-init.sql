create table Bookmark (timestampErstellt timestamp not null, timestampMutiert timestamp not null, version bigint not null, collection_id varchar(36) not null, folder_id varchar(36), id varchar(36) not null, url varchar(2000) not null, description varchar(5000), title varchar(255) not null, userErstellt varchar(255) not null, userMutiert varchar(255) not null, primary key (id));
