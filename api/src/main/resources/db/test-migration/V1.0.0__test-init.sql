...
create table User (aktiv boolean not null, lastUsedSessionTimestamp timestamp, timestampErstellt timestamp not null, timestampLastManuallyActivated timestamp, timestampMutiert timestamp not null, version bigint not null, id varchar(36) not null, fachRollen varchar(2000), email varchar(255) not null, keycloakId varchar(255), lastUsedIp varchar(255), lastUsedSessionId varchar(255), nachname varchar(255) not null, oidcIssuer varchar(255), titel varchar(255), userErstellt varchar(255) not null, userMutiert varchar(255) not null, vorname varchar(255) not null, primary key (id));
