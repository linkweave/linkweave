...
create table Folder (color varchar(7), timestampErstellt timestamp not null, timestampMutiert timestamp not null, version bigint not null, collection_id varchar(36) not null, id varchar(36) not null, parent_id varchar(36), name varchar(255) not null, userErstellt varchar(255) not null, userMutiert varchar(255) not null, primary key (id));
