...
/**
 * Jackson (de)serialization for {@link ID}, plus JAX-RS/Jackson registration helper.
 * Serializes an ID as its UUID string and deserializes by recovering the entity
 * type from the contextual generic type information.
 */
@UtilityClass
