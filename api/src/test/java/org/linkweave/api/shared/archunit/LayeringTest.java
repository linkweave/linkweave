...
class LayeringTest {
    ...
    public static final DescribedPredicate<JavaClass> SHARED = resideInAPackage("org.linkweave.api.shared..");

    private static final DescribedPredicate<JavaClass> DATABASE_LAYER =
        resideInAPackage("org.linkweave.infrastructure.db..")
            .or(resideInAPackage("org.linkweave.api.shared.abstractentity.."))
    ...
    public static final DescribedPredicate<JavaClass> SHARED_PRINTER =
        resideInAPackage("org.linkweave.api.shared.printer..");

    public static final DescribedPredicate<JavaClass> CSV_COLUMNS =
        resideInAPackage("org.linkweave.api.features.spss.columns..");
